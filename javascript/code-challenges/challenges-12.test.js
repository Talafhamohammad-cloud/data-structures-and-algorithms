...
const validatePin = (pin) => {
  // Solution code here...
  let validate = /\b[0-9]{4}\b/g;
  let newString = validate.test(pin);
...
const validateWord = (word) => {
  // Solution code here...
  let reg = /\b[a-z]{5,10}\b/gi;
  let variable = (reg.test(word));
  return variable;
};
...
const validateEmail = (email) => {
  // Solution code here...
  let reg = /^[A-z0-9]+.[A-z0-9]+@\w*(\.com|\.net|\.org)$/gi;
  let variable = (reg.test(email));
  return variable;
};
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  let variable = (ptrn.test(phoneNumber));
  return variable;
};
